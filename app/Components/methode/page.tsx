    ...
    <section className="bg-gray-50 py-16">
      <div className="max-w-screen-xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center">
          <img
            ...
            alt="Teinture artisanale - Manguimissou Textile"
        ...
        <div className="space-y-6">
          ...
          <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
            ...
            uniques qui racontent une histoire. Nos techniques comprennent des teintures artisanales, 
            des motifs imprimés avec précision et des traitements respectueux de l’environnement.
          </p>
          <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
            Chaque étape de la production est réalisée avec soin, en utilisant des teintures naturelles 
            pour réduire notre impact environnemental. Nous visons à produire des tissus qui inspirent 
            la créativité tout en respectant la nature et en garantissant une qualité exceptionnelle.
          </p>
          <button className="px-6 py-3 bg-yellow-500 text-white font-semibold rounded-lg shadow-lg hover:bg-yellow-600 transition duration-300">
      ...
      <div className="mt-16 bg-yellow-50 py-8">
        <div className="max-w-screen-xl mx-auto px-4 text-center space-y-4">
          ...
          <ul className="text-gray-600 space-y-2 sm:space-y-4">
